...
@section('content')
		...
		<div class="row row1">
			...
			<div class="col-lg-6 col-lg-offset-3 col1">
					...
					<form action="/newToDoupdate/{{ $updates->id }}" method="POST">

						{{ csrf_field() }}

						<div class="form-group">

							<input class="form-control" type="text" name="addToDoupdate" placeholder="{{ $updates->task }}" required>
						...
						<div class="right-content">
							...
							<ul>
								...
								@foreach($allTodos as $todo)
									...
									<li class="li1"><a class="btn alert-denger">Delete</a></li>
